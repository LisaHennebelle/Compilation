...
static const yytype_uint16 yyrline[] =
{
     ...
     157,   163,   170,   177,   185,   193,   202,   212,   218,   221,
     226,   232,   237,   242,   247,   252,   257,   262,   267,   271,
     277,   283,   288,   293,   298,   303,   308,   313,   318,   323,
     328,   333,   338,   343,   348,   353,   358,   363,   368,   373,
     378,   383,   388,   393,   399,   405,   410,   415,   420,   425,
     432,   437,   443,   447,   454
};
#endif
...
#line 122 "grammar.y" /* yacc.c:1646  */
    { printf("REGLE listdecl : epsilon");(yyval.ptr) = NULL; }
...
#line 132 "grammar.y" /* yacc.c:1646  */
    {
                ...
                printf("$1 = %s\n$2 = %s\n", node_nature2string((yyvsp[-1].ptr)->nature), node_nature2string((yyvsp[0].ptr)->nature));
...
#line 141 "grammar.y" /* yacc.c:1646  */
    {
                ...
                printf("$1 = %s\n$2 = %s\n", node_nature2string((yyvsp[-2].ptr)->nature), node_nature2string((yyvsp[-1].ptr)->nature));
...
#line 150 "grammar.y" /* yacc.c:1646  */
    {
        	...
        	couleur("34"); printf("NODE_TYPE $$ = %s\n", node_type2string((yyval.ptr)->type));couleur("0");//*program_root = $$;
		}
...
#line 203 "grammar.y" /* yacc.c:1646  */
    {
                ...
                printf("$1 = %s\n$2 = %s\n$5 = %s\n", node_nature2string((yyvsp[-4].ptr)->nature), node_nature2string((yyvsp[-3].ptr)->nature), node_nature2string((yyvsp[0].ptr)->nature));
