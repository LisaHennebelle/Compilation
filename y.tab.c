...
{
       0,    94,    94,   103,   113,   122,   124,   131,   140,   149,
     155,   161,   168,   175,   183,   191,   200,   208,   214,   217,
     222,   228,   233,   238,   243,   248,   253,   258,   263,   267,
     273,   279,   284,   289,   294,   299,   304,   309,   314,   319,
     324,   329,   334,   339,   344,   349,   354,   359,   364,   369,
     374,   379,   384,   389,   395,   401,   406,   411,   416,   421,
     428,   433,   439,   443,   450
};
#endif
...
#line 132 "grammar.y" /* yacc.c:1646  */
    {
                ...
                printf("$1 = %s\n$2 = %s", node_nature2string((yyvsp[-1].ptr)->nature), node_nature2string((yyvsp[0].ptr)->nature));
				make_node(NODE_LIST, 2, (yyvsp[-1].ptr), (yyvsp[0].ptr));
                couleur("34"); printf("NODE_LIST $$ = %s\n", node_nature2string((yyval.ptr)->nature));couleur("0");
            	//*program_root = $$;
			}
...
#line 141 "grammar.y" /* yacc.c:1646  */
    {
                printf("vardecl\n");
                printf("$1 = %s\n$2 = %s", node_nature2string((yyvsp[-2].ptr)->nature), node_nature2string((yyvsp[-1].ptr)->nature));
...
#line 176 "grammar.y" /* yacc.c:1646  */
    {
                    printf("$1 = %s\n$3 = %s", node_nature2string((yyvsp[-2].ptr)->nature), node_nature2string((yyvsp[0].ptr)->nature));
...
#line 184 "grammar.y" /* yacc.c:1646  */
    {
            printf("decl : ident\n");
            printf("$1 = %s\n", node_nature2string((yyvsp[0].ptr)->nature));
...
#line 201 "grammar.y" /* yacc.c:1646  */
    {
                ...
                couleur("34"); printf("NODE_FUNC %s %s %s\n", node_nature2string((yyvsp[-4].ptr)->nature), node_nature2string((yyvsp[-3].ptr)->nature), node_nature2string((yyvsp[0].ptr)->nature));couleur("0");//*program_root = $$;
...
#line 390 "grammar.y" /* yacc.c:1646  */
    {
            ...
            printf("$2 = %s\n",node_nature2string((yyvsp[-1].ptr)->nature));
...
#line 396 "grammar.y" /* yacc.c:1646  */
    {
            ...
            printf("$1 = %s\n$3 = %s\n", node_nature2string((yyvsp[-2].ptr)->nature), node_nature2string((yyvsp[0].ptr)->nature));
		}
