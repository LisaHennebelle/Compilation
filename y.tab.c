...
{
       0,    97,    97,   104,   112,   118,   123,   130,   139,   146,
     152,   158,   165,   170,   177,   183,   191,   200,   205,   208,
     212,   217,   221,   225,   229,   233,   237,   241,   245,   249,
     254,   259,   263,   267,   271,   275,   279,   283,   287,   291,
     295,   300,   305,   310,   315,   320,   325,   330,   335,   340,
     345,   350,   355,   360,   366,   372,   377,   382,   387,   392,
     398,   402,   408,   412,   418
};
#endif
...
#line 124 "grammar.y" /* yacc.c:1646  */
    {
				...
				(yyval.ptr) = make_node(NODE_LIST, cptvar, (yyvsp[0].ptr));
			}
...
#line 131 "grammar.y" /* yacc.c:1646  */
    {
                ...
                (yyval.ptr) = make_node(NODE_LIST, cptenfants, (yyvsp[-1].ptr), (yyvsp[0].ptr));
			}
